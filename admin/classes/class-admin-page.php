...
/**
 * Class Cheers_Forms_Admin_Page
 *
 * Serves as template for all admin pages
 */
if ( class_exists( 'Cheers_Forms_Admin_Page' ) ) {
	...
	class Cheers_Forms_Admin_Page {
		...
		/**
		 * Cheers_Forms_Admin_Page constructor.
		 *
		...
		protected function display() {
			cheers_forms_load_admin_view( "{$this->slug}-page" );
		}
		...
		public function render() {
			?>
			<div id="container" class="wrap wrap-<?php echo esc_attr( cheers_forms_slug() ); ?>">
				<?php $this->display(); ?>
			</div><!-- end container -->
			<?php
		}
